...
var objpasswaring=document.getElementById("passwarning");
var objpassword=document.getElementById("Password");
...
function judgepassword()
{
	...
	if(regnumber.exec(sPassword)||regab.exec(sPassword))
	{
		...
		passwaring.innerHTML="×"+arrErrorInfos[3];
		passwaring.style.color="red";
		//高亮显示
	...
	if(iPassword<6 ||iPassword>16)
	{
		flag2=1;
		//提示错误
		passwaring.innerHTML="×"+arrErrorInfos[2];
		passwaring.style.color="red";
		//高亮显示
		objpassword.style.backgroundColor="#A69D86";
	}
	...
	{
		//显示密码可用
		passwaring.innerHTML="√"+arrCorrectInfos[1];
		objpassword.style.backgroundColor="white";
		passwaring.style.color="green";
		return true;
	}
	else
	{
...
function Submit()
{
	...
	//判断每一项信息是否正确
	//正确跳转成员页
	else if(judgename()&&judgepassword()&&judgeconfirm()&&judgemobile()&&isCorrectVR())
	{
		alert("注册成功");
